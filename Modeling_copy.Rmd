...
k1 = ggplot(data = mutate(Merged_data_NTL_clean, Return_Ukraine = ifelse(Return_Ukraine == 1, "Yes", "No"))) + geom_boxplot(aes(x= diff_in_days, fill = Return_Ukraine)) + labs(title = "By Return Intention", x = "# Days Between")+ guides(fill=guide_legend(title="Return to UKR"))

k2 = ggplot(data = mutate(Merged_data_NTL_clean, Return_Ukraine = ifelse(Return_Ukraine == 1, "Yes", "No"))) + geom_boxplot(aes(x= diff_in_days, y = location, fill = Return_Ukraine), show.legend = FALSE) + labs(title = "By Location and Return Intention", x = "# Days Between")+ guides(fill=guide_legend(title="Return to UKR"))

grid.arrange(k1, k2, top = textGrob("Figure 12: Days Between Respondent's Arrival and Interview "))
```
